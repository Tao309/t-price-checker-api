    ...
    public function postDispatch(string $actionMethod, array $data): void
    {
        $this->tResponse->appendData([
            'config' => [
                ...
                'book_publishing_brands' => Config::getPublishingBrands(),
                'book_series' => Config::getBookSeries(),
            ],
            'shop_urls' => [
                Config::TYPE_WILDBERRIES => Config::getWildberriesUrl(),
                Config::TYPE_OZON => Config::getOzonUrl(),
                Config::TYPE_CHITAI_GOROD => Config::getChitaiGorodUrl(),
                Config::TYPE_FFAN => Config::getFfanUrl(),
                Config::TYPE_KNIGOFAN => Config::getKnigofanUrl(),
            ],
